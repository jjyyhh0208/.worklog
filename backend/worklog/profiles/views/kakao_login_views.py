...
REACT_APP_BASE_URL = os.getenv('REACT_APP_BASE_URL', default='http://127.0.0.1:3000')
SOCIAL_AUTH_KAKAO_CLIENT_ID = os.getenv('SOCIAL_AUTH_KAKAO_CLIENT_ID')
...
class KakaoLoginCallback(generics.GenericAPIView, mixins.ListModelMixin):
    ...
    def get(self, request, *args, **kwargs):
        ...
        user_info_response = requests.post(KAKAO_USER_API, headers=headers)
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Exceptions occurred: {e}")
                return redirect_to_next()
