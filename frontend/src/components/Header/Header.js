                    ...
                    <>
                        ...
                        >
                            <button
                                ...
                                className="bg-white text-[#4053ff] text-700 px-4 py-2 text-center text-xs sm:text-sm font-medium hover:bg-gray-100 transition-colors duration-300 rounded-lg min-w-[100px] flex-grow"
                            >
                                로그아웃
                            </button>
                            <button
