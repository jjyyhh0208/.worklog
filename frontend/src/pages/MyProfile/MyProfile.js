...
function MyProfile() {
    const [profileData, setProfileData] = useState({
        ...
        gender: 'Female',
        username: 'akinana',
        myWorkStyles: ['결단력 있는', '융통성 있는', '리더십 있는'],
        othersWorkStyles: ['통찰력 있는', '완벽주의적인', '융통성 있는'],
        interests: ['인공지능', '운영관리', '개발'],
        discScores: { D: 5, I: 7, S: 6.5, C: 2.5 },
    });
            ...
            <div className={styles.profileContent}>
                <div className={styles.profileHeader}>
                    <div className={styles.mainProfile}>
                        <img src={profileData.profileImage} alt="Profile" className={styles.profileImage} />
                        <div className={styles.profileDetails}>
                            ...
                            <div className={styles.basicDetails}>
                                <button className={styles.profileButton}>프로세서</button>
                            </div>
                        </div>
                    </div>
                ...
                <div className={styles.sectionsContainer}>
                    <div className={styles.section}>
                        ...
                        <div className={styles.stylesContainer}>
                            {profileData.myWorkStyles.map((style, index) => (
                                <span key={index} className={styles.styleTagMe}>
                                    {style}
                                </span>
                            ))}
                        </div>
                        ...
                        <hr className={styles.divider} />
                        <div className={styles.stylesContainer}>
                            {profileData.othersWorkStyles.map((style, index) => (
                                <span key={index} className={styles.styleTagYou}>
                                    {style}
                                </span>
                            ))}
                        </div>
                        ...
                        <button className={styles.keywordEditButton}>키워드 수정</button>
                    </div>
                    <div className={styles.section}>
                        ...
                        <div className={styles.discContainer}>
                            {Object.entries(profileData.discScores).map(([key, value]) => (
                                <div key={key} className={styles.discBar}>
                                    ...
                                    <span className={styles.score}>{calculatePercentage(value).toFixed(0)}</span>
                                </div>
                            ))}
                        </div>
                            ...
                            <div className={styles.aiSummary}>
                                ...
                                <div className={styles.aiFeedback}>
                                    <div className={styles.feedbackSummary}>
                                        서술형 피드백 문항별 요약~~~~~~프로세서형은 안정적인 환경을 선호하고 남을 먼저
                                        생각하기에 일의 진행속도가 느린편입니다. 효율적이고 분석적인 목표 달성자형과
                                        협업함으로써 더 체계적이고 빠르게 일을 처리하여 업무 효율을 높여줍니다.
                                    </div>
                                </div>
                            </div>
                        </div>
